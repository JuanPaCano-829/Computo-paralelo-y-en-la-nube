...
int main(int argc, char* argv[]) {
    ...
    if (argc != 4) { // ver si no hay argumentos de más
        cerr << "Uso correcto: " << argv[0] << " <.csv> <K_centros> <dimensiones(2 o 3)>\n";
    ...
    chrono::duration<double> duracion = tiempo_final - tiempo_inicial; // sacar el tiempo total 
    ...
    string archivo_salida = "resultado_" + archivo_Inicial; //nombre del archivo con los resultados
